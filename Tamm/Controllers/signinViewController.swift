...
class signinViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.usernameTf.attributedPlaceholder = NSAttributedString(string: "Username", attributes: [
        ...
        self.passTf.attributedPlaceholder = NSAttributedString(string: "Password", attributes: [
            .foregroundColor: UIColor.white,
            .font: UIFont(name: "OpenSans-Semibold", size: 12)!
            ])
